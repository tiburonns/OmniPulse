...
Descarga `OmniPulse-AltStore-v1.0.1.ipa` desde la [versión 1.0.1 de GitHub](https://github.com/tiburonns/OmniPulse/releases/tag/v1.0.1), o agrega esta fuente a AltStore:
...
La versión 1.0.1 conserva toda la aplicación del iPhone y excluye únicamente `Payload/OmniPulse.app/Watch` del paquete para instalación lateral. La app de Apple Watch no se elimina del proyecto y sigue incluida al compilar el esquema completo en Xcode o al distribuir mediante TestFlight/App Store.
...
2. Abre AltStore, agrega la fuente indicada arriba e instala OmniPulse 1.0.1. También puedes descargar la IPA y abrirla con AltStore.
...
2. Abre Sideloadly y selecciona `OmniPulse-AltStore-v1.0.1.ipa`.
...
- Confirma que el nombre del archivo sea `OmniPulse-AltStore-v1.0.1.ipa` y no la IPA 1.0.
